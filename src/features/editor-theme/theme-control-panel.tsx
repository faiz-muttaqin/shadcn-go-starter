...
import { type Theme, type ThemeEditorControlsProps, type ThemeStyleProps  } from "@/types/theme";

import ThemeEditActions from "./components/theme-edit-actions";
...
import HslAdjustmentControls from "./components/hsl-adjustment-controls";
...
const ThemeControlPanel = ({
  ...
  useEffect(() => {
    ...
    themePromise
      ...
      .catch((err) => {
        console.error("Failed to load themePromise:", err);
        if (mounted) setTheme(null);
      });
