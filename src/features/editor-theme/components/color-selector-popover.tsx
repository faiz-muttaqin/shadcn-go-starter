...
import {IconTailwindCSS} from "@/assets/brand-icons";
...
import { type ColorSelectorTab, usePreferencesStore } from "@/stores/preferences-store";
    ...
    <Popover>
      <PopoverTrigger asChild>
        <TooltipWrapper asChild label="Tailwind Colors">
          ...
          >
            <IconTailwindCSS className="text-foreground group-hover:text-accent-foreground size-4 transition-colors" />
          </Button>
        </TooltipWrapper>
      </PopoverTrigger>
        ...
        <Tabs defaultValue={colorSelectorTab} onValueChange={handleTabChange}>
          <div className="flex items-center justify-between gap-4">
            <div className="ml-2 flex items-center gap-1.5">
              <IconTailwindCSS className="size-4" />
